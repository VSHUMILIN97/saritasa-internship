...
class DictMergeTest(unittest.TestCase):
    ...
    def test_merge_is_completed(self):
        """This test checks whether merging was successful or not
        """
    ...
    def test_behaviour_after_incorrect_type(self):
        """This test checks whether system shutdown with code 1 or
           raises an exception
        """
    ...
    def test_merge_unique_dicts(self):
        """This test checks whether result of merging unique dicts
           is right
        """
